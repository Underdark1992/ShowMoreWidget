...
export function getProperties(
    _values: ShowMoreWidgetPreviewProps,
...
// export function getPreview(values: ShowMoreWidgetPreviewProps, isDarkMode: boolean, version: number[]): PreviewProps {
...
// export function getCustomCaption(values: ShowMoreWidgetPreviewProps, platform: Platform): string {
